...
class InferenceArguments:
    ...
    template_name: str = field(default="", metadata={"help": "sft时的数据格式"})
    eval_file: Optional[str] = field(default="", metadata={"help": "验证集"})
    per_device_eval_batch_size: int = field(default=1, metadata={"help": "batch size"})
    output_dir: str = field(default="sft", metadata={"help": "输出路径"})
    adapter_name_or_path: str = field(default="sft", metadata={"help": "adapter path"})
